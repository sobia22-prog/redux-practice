      ...
      <section className="mx-auto grid max-w-7xl grid-cols-1 gap-12 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <button className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3 font-semibold text-white cursor-pointer shadow-md transition hover:bg-indigo-700 hover:shadow-lg">
              Add to Cart
            </button>

            <button className="rounded-xl border border-gray-300 bg-white px-6 py-3 font-semibold text-gray-700 cursor-pointer shadow-sm transition hover:bg-gray-50 hover:shadow">
              Wishlist
            </button>
          </div>
        </div>
